...
public class Ventana extends JFrame{
	...
	public int votos1() {
		return Integer.parseInt(votos1.getText());
	}
	
	public int votos2() {
		return Integer.parseInt(votos2.getText());
	}
	
	public int votos3() {
		return Integer.parseInt(votos3.getText());
	}
	
	public int getPresupuesto1() {
		return Integer.parseInt(pro1.getText());
	}
	
	public int getPresupuesto2() {
		return Integer.parseInt(pro2.getText());
	}
	
	public int getPresupuesto3() {
		return Integer.parseInt(pro3.getText());
	}
