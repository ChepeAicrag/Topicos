...
public class VistaBiblioteca extends JFrame {
    ...
    public VistaBiblioteca() {
        ...
        sp.putConstraint(SpringLayout.SOUTH, btnExit, -10, SpringLayout.SOUTH, contenedor);
        sp.putConstraint(SpringLayout.WEST, btnExit, 355, SpringLayout.WEST, contenedor);
        setVisible(true);
    }

    public void conectaControlador(ControladorBiblioteca c) {
        btnAdd.addActionListener((ActionListener) c);
        btnAdd.setActionCommand("INSERTAR");
        btnDel.addActionListener((ActionListener) c);
        btnDel.setActionCommand("BORRAR");
        btnUpd.addActionListener((ActionListener) c);
